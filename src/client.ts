...
export interface ClientOptions {
  /**
   * Defaults to process.env['MET_MUSEUM_DEMO_API_KEY'].
   */
...
export class MetMuseum {
  ...
  constructor({
    ...
    const options: ClientOptions = {
      apiKey,
      ...opts,
      baseURL: baseURL || `https://collectionapi.metmuseum.org/public/collection/v1`,
    };
...
export declare namespace MetMuseum {
  ...
  export { Departments as Departments, type DepartmentListResponse as DepartmentListResponse };

  export { Search as Search, type SearchListParams as SearchListParams };
}
